...
public class AddonWebCall extends AsyncTask {
	private Set<String> al = new HashSet<String>();
	private static final String ParseTAG = "Addon";
	private static final String ADDONTAG = "addonname"; 
	
	@Override
	protected Object doInBackground(Object... params) {
		String result = null;
		String url = "http://10.0.2.2:8000/addonmenu";
