...
public class DrinkWebServiceActivity extends Activity {
	private static final String TAG3 = "DrinkName";
	private static final String TAG4 = "DrinkQuan"; 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_web_service_drink);
		Intent intent = getIntent();
		String message = intent.getStringExtra(MainActivity.EXTRA_MESSAGE);
		AsyncTask result = new DrinkWebCall().execute();
		try {
			...
			while(itr.hasNext()){
				...
				rb.setOnClickListener(new View.OnClickListener(){	
	            	public void onClick(View view){
	            		Log.v(TAG2, drinkname);   
	            		WebMenu.drinkname = drinkname;
			...
			textquantity.addTextChangedListener(new TextWatcher() {
				   ...
				   public void onTextChanged(CharSequence s, int start, 
				     int before, int count) {
					   WebMenu.drinkquantity = s.toString();
				   }
				  });
			...
			addtocartbutton.setOnClickListener(new View.OnClickListener(){	
	        	public void onClick(View view){  
	        		Log.v(TAG3, WebMenu.drinkname);
	        		Log.v(TAG4, WebMenu.drinkquantity);
